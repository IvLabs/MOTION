...
z_hip(1,1:interpolations)=height_of_pend+28;  %height of pendulum
x_ankle=linspace(0,2*x_max,interpolations);
p=linspace(-x_max,x_max,interpolations);
z_ankle=(step_height/2)*cos((p*pi/(x_max)))+(step_height*(0.5+increment_factor));
